...
-- SELECT lots.title, start_price, image, price, categories.title
-- FROM lots
...
-- SELECT lots.id, lots.title, start_price, image, date_exp, categories.title, users.name
-- FROM lots
--        JOIN categories ON categories.id = category_id
...
FROM bets
       JOIN lots ON author_id = user_id
